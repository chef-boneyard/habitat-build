...
#
# TODO: (jtimberman) This will be moved to the Habitat project repo as
# `components/ruby-client` when we can start publishing it as a public
# RubyGem. It's there now, but the code isn't in sync with this
# content.
